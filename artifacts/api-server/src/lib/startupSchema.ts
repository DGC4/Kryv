...
export async function ensureAdminTreasuryContextSchema(): Promise<void> {
  ...
  // Focus Mode is a single owner-controlled presentation setting. It stores only
  // a selected existing channel or published Cinema title and does not change
  // content ownership, money movement, custody, or ad-delivery capabilities.
  await db.execute(sql`
