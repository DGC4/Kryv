...
function FocusChat({ channelId, channelName }: { channelId: number; channelName: string }) {
...
function LiveFocus({ sourceId, chatEnabled, announcementText }: Omit<FocusModeShellProps, 'sourceType'>) {
  ...
  if (channelQuery.isLoading) return <div className="flex flex-1 items-center justify-center"><Loader2 className="h-7 w-7 animate-spin text-primary" /></div>;
...
function CinemaFocus({ sourceId, announcementText }: Omit<FocusModeShellProps, 'sourceType' | 'chatEnabled'>) {
  ...
  if (titleQuery.isLoading) return <div className="flex flex-1 items-center justify-center"><Loader2 className="h-7 w-7 animate-spin text-primary" /></div>;
