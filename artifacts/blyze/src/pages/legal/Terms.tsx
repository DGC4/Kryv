      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-12 text-base leading-relaxed text-white/80 sm:text-lg">
          <section className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-6 sm:p-8">
            <p className="font-medium leading-relaxed text-white/90">Welcome to Kryv. These Terms of Service (&ldquo;Terms&rdquo;) govern access to Kryv Live, Kryv Watch, Kryv Clips, Kryv Cinema, creator tools, and related services (collectively, the &ldquo;Service&rdquo;). By creating an account, accessing the Service, streaming, uploading, clipping, or using creator tools, you agree to these Terms, the <a href="/safety" className="font-bold text-primary hover:underline">Safety and Community Standards</a>, the <a href="/privacy" className="font-bold text-primary hover:underline">Privacy Policy</a>, and the <a href="/creator-economics" className="font-bold text-primary hover:underline">Creator Economics disclosure</a>.</p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-white/70"><p>Channel owners and authorized moderators may remove chat messages, apply timeouts, ban users, adjust channel chat settings, and manage eligible engagement tools. Viewers may use available report controls to flag content or chat in context. Kryv retains final authority over safety, moderation, account, entitlement, balance, and publication decisions under the <a href="/safety" className="font-bold text-primary hover:underline">Safety and Community Standards</a>.</p><p>Kryv may offer a browser camera and microphone preflight. Device access is requested only after a creator expressly selects the check in a compatible secure browser. A local preview is not a live broadcast, recording, upload, or destination relay. No browser broadcasting or external destination relay is activated unless Kryv expressly makes an authorized, provider-verified feature available.</p></div>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-black tracking-tight text-white sm:text-3xl">4. Crypto-only payments and creator balances</h2>
            <div className="space-y-4 text-white/70"><p>Kryv&apos;s active commerce and settlement model is crypto-only. Where enabled, supported payment methods are limited to Bitcoin (BTC), Litecoin (LTC), Ethereum (ETH), and Dogecoin (DOGE). Kryv does not offer card checkout or fiat checkout through the Service.</p><p>For eligible, provider-confirmed tips and subscriptions, Kryv&apos;s current creator allocation is 95% of the confirmed crypto subtotal and Kryv&apos;s platform allocation is 5%. A separately disclosed provider checkout commission, where applicable, is client-borne and excluded from that allocation. Network and payout-execution fees are provider- and network-dependent. <a href="/creator-economics" className="font-bold text-primary hover:underline">Read the Creator Economics disclosure.</a></p><p>Invoices, payment status, entitlements, creator balance movements, platform-fee movements, and payout-review records are determined on the server and reconciled through signed provider events. A creator balance is not a bank account, deposit account, or guarantee of value. Kryv does not offer customer wallet custody or automatic scheduled payout execution at this time. Payout requests and provider withdrawals remain subject to feature controls, verification, network conditions, fees, compliance review, and owner approval. Never provide a private key or seed phrase to Kryv.</p></div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-white/70">Kryv may update these Terms as the Service, security controls, provider relationships, or law changes. Continued use after an updated effective date means you accept the revised Terms to the extent permitted by law. Questions about these Terms, content rights, account access, or a safety decision may be submitted through Kryv&apos;s official support channels with the relevant channel, content, or case details. Jurisdiction-specific governing-law, dispute-resolution, and consumer-rights terms require legal review before final publication.</p>
          </section>
        </div>
      </div>
    </main>
