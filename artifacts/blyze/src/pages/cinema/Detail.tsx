  ...
  return (
    <div className="relative z-10 min-h-screen overflow-hidden bg-black text-white">
      ...
      <main className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10 lg:px-8">
        <div className="relative aspect-video overflow-hidden rounded-2xl border border-white/10 bg-black shadow-2xl sm:rounded-3xl"><HlsPlayer src={`https://stream.fastpix.com/${title.featurePlaybackId}.m3u8`} poster={title.backdropUrl || title.posterUrl || undefined} className="h-full w-full" /></div>
